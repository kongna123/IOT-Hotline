...
const FeaturedProducts = ({ language }) => {
  ...
  const featuredProducts = [
    ...
    },
    {
      ...
      price: 899,
      originalPrice: null,
      image: 'https://syslinktech.com/wp-content/uploads/2019/12/IMG_4285-768x855.png',
    ...
    },
    {
      ...
      price: 3299,
      originalPrice: 3899,
      image: 'https://syslinktech.com/wp-content/uploads/2019/12/K3HDcam-768x847.jpg',
    ...
    },
    {
      ...
      price: 599,
      originalPrice: 799,
      image: 'https://syslinktech.com/wp-content/uploads/2019/12/S312-B-768x510.jpg',
      category: language === 'th' ? 'สวิตช์อัจฉริยะ' : 'Smart Switches',
      rating: 4.5,
      reviews: 67,
